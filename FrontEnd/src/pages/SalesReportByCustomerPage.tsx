  ...
  const handleExportExcel = async () => {
    ...
    reportData.forEach((customer: SalesByCustomerItem, customerIdx: number) => {
      ...
      const customerRow = worksheet.addRow([
        ...
        customer.customerType === "INTERNAL" ? "Cửa hàng trưởng" : "Khách công nợ",
        "",
          ...
          <tbody>
            ${reportData
              ...
              <tr class="customer-row">
                ...
                <td>${customer.customerType === "INTERNAL" ? "Cửa hàng trưởng" : "Khách công nợ"}</td>
                <td></td>
                    ...
                    <React.Fragment key={customer.customerId}>
                      ...
                      >
                        ...
                        <td className="px-6 py-4 text-center">
                          ...
                          >
                            {isInternal ? "Cửa hàng trưởng" : "Khách công nợ"}
                          </span>
                        </td>
