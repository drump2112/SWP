  ...
  const getLoginErrorMessage = (
    ...
    if (status === 401) {
      ...
      if (
        ...
        serverMessage?.toLowerCase().includes("vô hiệu")
      ) {
        return {
    ...
    if (status === 403) {
      return {
        ...
        description:
          "Bạn không có quyền truy cập hệ thống. Vui lòng liên hệ quản trị viên.",
      };
    }
    ...
    if (status === 429) {
      return {
        ...
        description:
          "Bạn đã thử đăng nhập quá nhiều lần. Vui lòng đợi vài phút và thử lại.",
      };
    }
    ...
    if (status >= 500) {
      return {
        title: "Lỗi hệ thống",
        description:
          "Máy chủ đang gặp sự cố. Vui lòng thử lại sau hoặc liên hệ bộ phận kỹ thuật.",
      };
    }
    ...
    return {
      ...
      description:
        serverMessage || "Đã xảy ra lỗi không xác định. Vui lòng thử lại sau.",
    };
  };
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="hidden lg:flex items-center justify-center bg-gradient-to-br from-white via-blue-50 to-blue-100 p-12">
              <div className="text-center max-w-xl w-full px-8">
                <div className="mb-16">
                  <h2
                    className="font-black tracking-wider leading-tight uppercase"
                    style={{
                      fontFamily:
                        "'Montserrat', 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Helvetica Neue', sans-serif",
                ...
                <div className="relative">
                  <div
                    className="absolute
Chào mừng bạn đã đến-inset-2 bg-gradient-to-r from-orange-300 to-blue-400 rounded-3xl blur-xl opacity-30 animate-pulse"
                  ></div>
